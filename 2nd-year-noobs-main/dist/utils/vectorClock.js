 ...
 */
export function toVectorClockMap(clock) {
...
export function compareVectorClocks(clockA, clockB) {
    ...
    const allPeers = new Set([...mapA.keys(), ...mapB.keys()]);
    let hasLess = false;
 ...
 */
export function areVectorClocksConcurrent(clockA, clockB) {
 ...
 */
export function getOperationVectorClock(op) {
 ...
 */
export function compareOperations(opA, opB) {
 ...
 */
export function areOperationsConcurrent(opA, opB) {
